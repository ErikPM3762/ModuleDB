...
/**
 * Credenciales para acceso Aws
 */

extern "C" JNIEXPORT jstring JNICALL
Java_com_example_moduledb_controlDB_utils_Constants_getUserAws(JNIEnv *env, jobject) {
    std::string user = "devlr1";
    return env->NewStringUTF(user.c_str());
}
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_moduledb_controlDB_utils_Constants_getPasswordAws(JNIEnv *env, jobject) {
    std::string user = "Pegasus12$";
    return env->NewStringUTF(user.c_str());
}
extern "C" JNIEXPORT jstring JNICALL
Java_com_example_moduledb_controlDB_utils_Constants_getEmailAws(JNIEnv *env, jobject) {
    std::string user = "devlr1@mobilityado.com";
    return env->NewStringUTF(user.c_str());
}
